...
String pragraph2 ="There are three types of data communication modes which are given below: -\ni) Simplex\nii) Half-Duplex\niii) Full-Duplex";

//explaination
String point1 = "1.Simplex";
String point1Explanations ="In simplex mode, the commmunication is undirectional, as on a one way street. Only one of the two devices on a link can transmit, the other can only receive. Keyboard and traditional monitors are both examples of simplex. Keyboard can be only intorduce input, the monitor xan only accept the output. ";
String exmaple1 = 'Simples Only A to B\nFig:- Simplex Communication';

String point2 = '2.Half-Duplex';
String point2Explanations ="In Half-Fuplex mode, each station can both transmit and receive is sending, the other can only receive, anmd vice versa. In this mode, the entire capacity of a channel is taken over by whichever of teo deveices is transmittnig at the time. Wakie-Talkie is the best example of half-duplex system.";
String example2 ="Half-Duplex A to B or B to A\nFig:- Half-Duplex Communication";
