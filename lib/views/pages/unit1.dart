...
class DataBase extends StatelessWidget {
  ...
  const DataBase({this.initialHighlight, super.key});
          ...
          IconButton(
            ...
            onPressed: () {
              context.read<HighlightBloc>().add(
                const HighlightEvent.fetchByPage('unit1'),
              );
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    chapterHeading('Database'),
                    const SizedBox(height: 8.0),
                    const ChapterTopics(heading: 'Data'),
                    ...
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents: 'Eg. Chanakya, 32, 601 → Raw facts',
                      textAlign: TextAlign.justify,
                      style: TextStyle(fontSize: 17.0),
                    ),
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: "Information"),
                    const SizedBox(height: 5.0),
                    HeadingDetails(
                      pageId: 'unit1',
                      targetHighlight: initialHighlight,
                    ...
                    const ChapterTopics(heading: 'Database'),
                    const SizedBox(height: 6.0),
                    HeadingDetails(
                      pageId: 'unit1',
                      targetHighlight: initialHighlight,
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'Functions of Database'),
                    const SizedBox(height: 6.0),
                    HeadingDetails(
                      pageId: 'unit1',
                      targetHighlight: initialHighlight,
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'Database Management System'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'Objectives of DBMS'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'Advantages of DBMS'),
                    const SizedBox(height: 6.0),
                    const ChapterHeadingMedium(mediumHeading: '1.Sharing Data'),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'Models of Database'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 6.0),
                    const ChapterTopics(
                      heading: '1. Hierarchical Database Model',
                    ),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'Advantages'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const ChapterTopics(heading: 'Disavantages'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: '2. Network Database Model'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const ChapterTopics(heading: 'Disadvantages'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 6.0),
                    const ChapterTopics(
                      heading: '3. Relational Database Model',
                    ),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'Normalization'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: '1. First Normal Form(1NF)'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 20.0),
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: '2. Second Normal Form(2NF)'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: '3. Third Normal Form(3NF)'),
                    const Padding(
                      padding: EdgeInsets.symmetric(vertical: 0.1),
                      child: BulletedList(
                        listItems: [
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(
                      heading: 'Data Base Administrator(DBA)',
                    ),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(
                      heading: 'Resposibility of Data Base(DBA)',
                    ),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                    ...
                    const SizedBox(height: 20.0),
                    const ChapterTopics(heading: 'SQL'),
                    const SizedBox(height: 6.0),
                    const HeadingDetails(
                      pageId: 'unit1',
                      contents:
