...
class NetWork extends StatelessWidget {
  ...
  NetWork({this.initialHighlight, super.key});
          ...
          IconButton(
            ...
            onPressed: () {
              context.read<HighlightBloc>().add(
                const HighlightEvent.fetchByPage('unit2'),
              );
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const SizedBox(height: 20.0),
                        Text(point1, style: pointStyleText),
                        HeadingDetails(
                          pageId: 'unit2',
                          contents: point1Explanations,
                          textAlign: TextAlign.justify,
                          style: pragraphStyleText,
                        ),
                        ...
                        const SizedBox(height: 20.0),
                        Text(point2, style: headlineText),

                        HeadingDetails(
                          pageId: 'unit2',
                          contents: point2Explanations,
                          textAlign: TextAlign.justify,
                          style: pragraphStyleText,
                        ),
                        ...
                        const SizedBox(height: 20.0),
                        Text(headline3, style: headlineText),
                        const SizedBox(height: 6.0),
                        HeadingDetails(
                          pageId: 'unit2',
                          contents: pragraph3,
