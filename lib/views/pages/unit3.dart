...
class WebDevelopment extends StatelessWidget {
  ...
  const WebDevelopment({this.initialHighlight, super.key});
          ...
          IconButton(
            ...
            onPressed: () {
              context.read<HighlightBloc>().add(
                const HighlightEvent.fetchByPage('unit3'),
              );
                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        const TopicsHeadings(unit: 'Web Technology'),
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Client-Side Scripting programming',
                        ),
                        HeadingDetails(
                          pageId: 'unit3',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Server-Side Scripting programming',
                        ),
                        HeadingDetails(
                          pageId: 'unit3',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterTopics(heading: 'Feature of JavaScript'),
                        HeadingDetails(
                          pageId: 'unit3',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const ChapterTopics(heading: 'Uses of JavaScript'),
                        HeadingDetails(
                          pageId: 'unit3',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '1 .Inline JavaScript code',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const SizedBox(height: 8.0),
                        const ChapterHeadingMedium(
                          mediumHeading: '3. External JavaScript file',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'a) Primitive data type: ',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                        ...
                        Table(
                          ...
                          children: const [
                            ...
                            TableRow(
                              children: [
                                TableCell(child: Center(child: Text('Number'))),
                                TableCell(
                                  child: Padding(
                            ...
                            TableRow(
                              children: [
                                TableCell(child: Center(child: Text('String'))),
                                TableCell(
                                  child: Padding(
                                    padding: EdgeInsets.all(
                                      8.0,
                            ...
                            TableRow(
                              children: [
                                TableCell(child: Center(child: Text('Null'))),
                                TableCell(
                                  child: Padding(
                                    padding: EdgeInsets.all(
                                      8.0,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'b) Non-Primitive datatype:',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        Table(
                          ...
                          children: const [
                            ...
                            TableRow(
                              children: [
                                TableCell(child: Center(child: Text('Array'))),
                                TableCell(
                                  child: Padding(
                                    padding: EdgeInsets.all(
                                      8.0,
                        ...
                        const ChapterTopics(heading: 'Variables in JavaScript'),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'a) Local variable ',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'b) Global variable',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const ChapterTopics(
                          heading: 'DDL DML and DCL statements',
                        ),
                        const ChapterHeadingMedium(
                          mediumHeading: '1) Data Definition Language (DDL)',
                        ),
                        const ChapterHeadingMedium(
                          mediumHeading: '1.1 CREATE statement',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '1.2 DROP statement',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '2) Data Manipulation Language (DML)',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '2.1) SELECT statement',
                        ),
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '2.2) INSERT statement',
                        ),
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '2.3) DELETE statement',
                        ),
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '2.4) UPDATE statement',
                        ),
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '3) Data Control Language (DCL)',
                        ),
                        const HeadingDetails(
                          pageId: 'unit3',
                          contents:
