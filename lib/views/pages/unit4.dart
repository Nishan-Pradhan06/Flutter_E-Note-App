...
class ProgrammingC extends StatelessWidget {
  ...
  const ProgrammingC({this.initialHighlight, super.key});
          ...
          IconButton(
            ...
            onPressed: () {
              context.read<HighlightBloc>().add(
                const HighlightEvent.fetchByPage('unit4'),
              );
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const ChapterTopics(heading: 'Functions:'),
                        HeadingDetails(
                          pageId: 'unit4',
                        ...
                        const ChapterHeadingMedium(mediumHeading: 'Advantages'),
                        HeadingDetails(
                          pageId: 'unit4',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Recursive functions: (V.Imp)',
                        ),
                        HeadingDetails(
                          pageId: 'unit4',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterTopics(heading: 'File Handling in C'),
                        HeadingDetails(
                          pageId: 'unit4',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Opening a data file',
                        ),
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Store/write data',
                        ),
                        const HeadingDetails(
                          pageId: 'unit4',
                          contents:
