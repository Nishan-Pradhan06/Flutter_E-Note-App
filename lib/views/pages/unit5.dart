...
class OoP extends StatelessWidget {
  ...
  OoP({this.initialHighlight, super.key});
          ...
          IconButton(
            ...
            onPressed: () {
              context.read<HighlightBloc>().add(
                const HighlightEvent.fetchByPage('unit5'),
              );
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const ChapterTopics(heading: 'Characteristics of OOP'),
                        const SizedBox(height: 6.0),
                        ...
                        const SizedBox(height: 20.0),
                        const ChapterTopics(heading: 'Features/Element of OOP'),
                        const SizedBox(height: 6.0),
                        const Text(
                          '1.Object: ',
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterTopics(heading: 'Types of inheritance:'),
                        const SizedBox(height: 6.0),
                        const HeadingDetails(
                          pageId: 'unit5',
                          contents: "There are following tyeps of inhertance:-",
                          textAlign: TextAlign.justify,
                          style: TextStyle(
                            fontFamily: "Ubuntu",
                            fontSize: 17.0,
                        ...
                        const SizedBox(height: 20.0),
                        const ChapterTopics(heading: 'Advantages of OOP '),
                        const SizedBox(height: 6.0),
                        const HeadingDetails(
                          pageId: 'unit5',
                          contents:
                        ...
                        const SizedBox(height: 20.0),
                        const ChapterTopics(heading: 'Disadvantages of OOP '),
                        const SizedBox(height: 6.0),
                        const HeadingDetails(
                          pageId: 'unit5',
                          contents:
                        ...
                        const SizedBox(height: 20.0),
                        const ChapterTopics(heading: 'Applications of OOP  '),
                        const SizedBox(height: 6.0),
                        const HeadingDetails(
                          pageId: 'unit5',
                          contents:
