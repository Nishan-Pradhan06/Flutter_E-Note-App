...
class SpM extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(titleText: 'Unit 6'),
      body: PageView(
        children: [
          GestureDetector(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        ChapterTopics(heading: 'Software process model'),
                        ...
                        const SizedBox(height: 6.0),
                        ChapterHeadingMedium(medium_heading: 'Algorithm'),
                        HeadingDetails(
                          contents:
                        ...
                        ChapterHeadingMedium(
                          medium_heading: 'c. Implementation and unit testing:',
                        ),
                        HeadingDetails(
                          contents:
                        ...
                        const SizedBox(height: 6.0),
                        ChapterHeadingMedium(
                          medium_heading: 'd. Integration and system testing:',
                        ),
                        HeadingDetails(
                          contents:
                        ...
                        ChapterHeadingMedium(
                          medium_heading: 'Advantages of prototyping model',
                        ),
                        HeadingDetails(
                          contents:
                        ...
                        ChapterHeadingMedium(
                          medium_heading: 'Disadvantages of prototyping model',
                        ),
                        HeadingDetails(
                          contents:
                        ...
                        const SizedBox(height: 6.0),
                        ChapterHeadingMedium(medium_heading: 'Planning:'),
                        HeadingDetails(
                          contents:
                        ...
                        const SizedBox(height: 6.0),
                        ChapterHeadingMedium(medium_heading: 'Risk analysis:'),
                        HeadingDetails(
                          contents:
                        ...
                        ChapterHeadingMedium(medium_heading: '1) Algorithm:'),
                        HeadingDetails(
                          contents:
                        ...
                        ChapterHeadingMedium(medium_heading: '2) Flowchart:'),
                        HeadingDetails(
                          contents:
