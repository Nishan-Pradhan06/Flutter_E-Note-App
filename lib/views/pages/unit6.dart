...
class SpM extends StatelessWidget {
  ...
  SpM({this.initialHighlight, super.key});
          ...
          IconButton(
            ...
            onPressed: () {
              context.read<HighlightBloc>().add(
                const HighlightEvent.fetchByPage('unit6'),
              );
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const ChapterTopics(heading: 'Software process model'),
                        const SizedBox(height: 6.0),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        Image.asset(
                          "images/unit_6/component_system.png",
                          height: 120,
                        ),
                        const SizedBox(height: 6.0),
                        const Text(
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'd) Operational feasibility:',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(mediumHeading: 'Algorithm'),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(mediumHeading: 'Flowchart'),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '5) System Development (Coding): ',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(
                          mediumHeading: '6) System Testing :',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'b) White box testing:f',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '7) System implementation: ',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: '8) System maintenance: ',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        // ChapterHeadingMedium(mediumHeading: '')
                        const SizedBox(height: 6.0),
                        const ChapterTopics(
                          heading: 'System Development Model',
                        ),
                        const ChapterHeadingMedium(
                          mediumHeading: 'A) The waterfall Model: ',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        Column(
                          children: [
                            Image.asset("images/unit_6/sdlc.png"),
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(
                          mediumHeading: 'b. System and software design:',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'c. Implementation and unit testing:',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(
                          mediumHeading: 'd. Integration and system testing:',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(
                          mediumHeading: 'B) Prototyping Model:',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterTopics(
                          heading: 'Development of prototype.',
                        ),
                        const ChapterHeadingMedium(
                          mediumHeading: 'Identify user problem:',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Develop a prototype: ',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Use the prototype:',
                        ),
                        const HeadingDetails(
                          pageId: 'unit6',
                          contents: "The prototype becomes operational system.",
                        ),

                        const ChapterHeadingMedium(
                          mediumHeading: 'Advantages of prototyping model',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Disadvantages of prototyping model',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        Column(
                          children: [
                            Image.asset("images/unit_6/sprialmodel.png"),
                            const Text('Fig:- Spiral Model'),
                          ],
                        ),
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(mediumHeading: 'Planning:'),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const SizedBox(height: 6.0),
                        const ChapterHeadingMedium(
                          mediumHeading: 'Software development: ',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Advantages of spiral model',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Disadvantage of spiral model',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterTopics(heading: 'System design tool'),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                          contents:
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'Program Flowchart:',
                        ),
                        HeadingDetails(
                          pageId: 'unit6',
                          targetHighlight: initialHighlight,
                        ...
                        const ChapterHeadingMedium(
                          mediumHeading: 'System flowchart:',
                        ),
                        const HeadingDetails(
                          pageId: 'unit6',
                          contents:
  ...
  Center sourceLinks() {
    return Center(
      child: RichText(
        text: TextSpan(
          children: [
            TextSpan(style: defaultText, text: "Sources:"),
            TextSpan(
              style: linkText,
